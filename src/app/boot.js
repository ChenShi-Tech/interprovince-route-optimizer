...
document.addEventListener('change',e=>{
  ...
  if(id==='i-pdst') state.pDstManual=true;
  if(id.startsWith('i-rloss-')){ state.sel=0; doSolve(); return; }
  if(['i-qty','i-hours','i-hops','i-detour','i-degrade','i-pgen','i-pdst','i-pnet','i-fund','i-bearer','i-region','i-dstcost','i-tradable','i-zyocc','i-regionloss','i-date','i-sourcequote','i-originloss','i-regioncharge'].indexOf(id)>=0){
